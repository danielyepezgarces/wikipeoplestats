<?php
include 'languages.php'; // cargar traducciones
...
$groups = [
    'wikimedia-argentina' => [
        ...
        'credits' => 'Estadísticas por Wikimedia Argentina',
    ],
];
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($group_name) . ' - ' . __('sitename'); ?></title>
    ...
    <style>#members-modal { background-color: rgba(0,0,0,0.6); }</style>
</head>
...
<main class="container mx-auto px-4 py-8">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-10 w-full relative">
        <div class="relative">
            <div class="h-72 w-full bg-cover bg-center rounded-t-lg"
                ...
                <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/70 to-transparent text-white p-6">
                    <p class="text-lg mt-2"><?php echo htmlspecialchars($group_description); ?></p>
                </div>
        ...
        <div class="mt-20 text-center px-6">
            <h2 class="text-3xl font-bold mb-4"><?php echo htmlspecialchars($group_name); ?></h2>
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-6 text-lg">
                <div><strong><?php echo __('group_admin'); ?>:</strong> <?php echo htmlspecialchars($admin_name); ?></div>
                <div><strong><?php echo __('members_count'); ?>:</strong>
                    <span class="cursor-pointer text-blue-600" onclick="openModal()"><?php echo (int)$members_count; ?></span>
                </div>
                <div><strong><?php echo __('creation_date'); ?>:</strong> <?php echo htmlspecialchars($creation_date); ?></div>
            </div>
            ...
            <p class="mt-6 text-sm italic text-gray-600 dark:text-gray-400"><?php echo htmlspecialchars($credits); ?></p>
        </div>
    </div>
</main>
<div id="members-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-lg w-full">
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="closeModal()" class="text-gray-600 dark:text-gray-300 text-3xl font-bold leading-none">&times;</button>
        </div>
