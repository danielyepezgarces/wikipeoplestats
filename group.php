<?php
include 'languages.php'; // Traducciones e idioma

$slug = $_GET['slug'] ?? '';

// Simular base de datos de grupos
$grupos = [
    'wikimedia-argentina' => [
        ...
        'image' => 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Wikimedia_Argentina_logo_white.svg',
...
// Si el slug no existe, redirige a /groups/
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($grupo['name']) . ' - ' . __('sitename'); ?></title>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-10 w-full">
        <div class="relative">
            <div class="h-72 w-full bg-cover bg-center rounded-t-lg"
                 style="background-image: url('<?php echo $grupo['cover']; ?>'); background-position: bottom;">
                <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/70 to-transparent text-white p-6">
                    <p class="text-lg mt-2"><?php echo $grupo['description']; ?></p>
                </div>
            ...
            <div class="absolute -bottom-16 left-1/2 transform -translate-x-1/2">
                <div class="h-36 w-36 rounded-full p-2 shadow-lg bg-gray-100 dark:bg-gray-700">
                    <img src="<?php echo $grupo['image']; ?>" alt="Group Avatar"
        ...
        <div class="mt-20 text-center px-6">
            <h2 class="text-3xl font-bold mb-4"><?php echo $grupo['name']; ?></h2>
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div><strong><?php echo __('group_admin'); ?>:</strong> <?php echo $grupo['admin']; ?></div>
                <div><strong><?php echo __('members_count'); ?>:</strong>
                    <span class="cursor-pointer text-blue-600" onclick="openModal()"><?php echo $grupo['members_count']; ?></span>
                </div>
                <div><strong><?php echo __('creation_date'); ?>:</strong> <?php echo $grupo['creation_date']; ?></div>
            </div>
