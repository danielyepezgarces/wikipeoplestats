...
<body>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8 w-full">
        ...
        <form class="mt-6 grid grid-cols-3 gap-4" onsubmit="return redirectToUrl()">
            ...
            <input type="date" id="start_date" name="start_date" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-primary-500 appearance-none">
            ...
            <input type="date" id="end_date" name="end_date" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-primary-500 appearance-none">
