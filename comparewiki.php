...
<p class="text-xl text-gray-700 text-center justify-center dark:text-gray-300">
    ...
    fetch(`https://api.wikipeoplestats.org/v1/genders/graph/<?php echo $projectA; ?>/<?php echo $start_date; ?>/<?php echo $end_date; ?>`),
    fetch(`https://api.wikipeoplestats.org/v1/genders/graph/<?php echo $projectB; ?>/<?php echo $start_date; ?>/<?php echo $end_date; ?>`)
]);
