...
<footer class="mx-auto w-full max-w-container px-4 sm:px-6 lg:px-8">
    ...
    <div class="inline-flex items-center bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-xl p-2 px-4 shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 w-full sm:w-auto mb-4 sm:mb-0 h-32">
        <a href="https://wikitech.wikimedia.org/wiki/Help:Cloud_Services_introduction" target="_blank" class="flex items-center w-full h-full">
            ...
            <div class="flex flex-col items-center sm:items-start text-center w-full h-full justify-center">
    ...
    <div class="inline-flex items-center bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-xl p-2 px-4 shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 w-full sm:w-auto mb-4 sm:mb-0 h-32">
        <a href="https://www.wikidata.org" target="_blank" class="flex items-center w-full h-full">
    ...
    <div class="inline-flex items-center bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-xl p-2 px-4 shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 w-full sm:w-auto mb-4 sm:mb-0 h-32">
        <a href="https://qlever.cs.uni-freiburg.de/wikidata" target="_blank" class="flex items-center w-full h-full">
